...
public class BasicStreamsExercise06 {
	...
	/**
	 * Exercise 6: Format a list of products into a string, with one product per
	 * line.
	 *
	...
	public String formatProductList(List<Product> products) {
		// TODO: Convert each of the products to a string (using Product.toString()) and
		// collect the results in a string.
		// Separate the products strings by a newline character '\n'.
		//
		// Hint: Use the appropriate collector in the last step to convert the product
